            ...
            <div class="row">
                <div class="col-md-12">
                    <div class="card card-primary">
                        ...
                        <!-- form start -->
                        <form action="<?= base_url('addFeatureH') ?>" method="post" enctype="multipart/form-data">
                            <div class="card-body">
                                <div class="row">
                                    <div class="col-sm-4">
                                ...
                                <div class="form-group">
                                    <input type="hidden" class="form-control" name="content_section" value='feature_heading'>
                                </div>
                                <div class="form-group">
                            ...
                            <div class="card-footer">
                                <button type="submit" class="btn btn-primary" name="create_feature_heading">Save</button>
                            </div>
                        </form>
                    </div>
                </div>
